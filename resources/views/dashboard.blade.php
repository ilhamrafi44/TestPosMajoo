                    ...
                    <ul class="list-unstyled list-unstyled-border">
                        <li class="media">
                            ...
                            <div class="media-body">
                                ...
                                <div class="media-title">Links Cloacked</div>
                        ...
                        <li class="media">
                            <img class="mr-3 rounded-circle" width="50"
                                src="{{ asset('assets/img/avatar/avatar-4.png') }}" alt="avatar">
                            <div class="media-body">
                ...
                <div class="card-body">
                    <ul class="list-unstyled list-unstyled-border">
                        ...
                        <li class="media">
                            ...
                            <img class="mr-3 rounded-circle" width="50"
                                src="{{ asset('assets/img/avatar/avatar-5.png') }}" alt="avatar">
                            <div class="media-body">
                        ...
                        <li class="media">
                            ...
                            <img class="mr-3 rounded-circle" width="50"
                                src="{{ asset('assets/img/avatar/avatar-2.png') }}" alt="avatar">
                            <div class="media-body">
