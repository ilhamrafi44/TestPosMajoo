...
<head>
    ...
    <title>Login &mdash; Cloack Web</title>
        ...
        <div class="main-wrapper">
            ...
            <div class="main-sidebar bg-dark">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html" class="text-white">Cloack Web</a>
                    </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a class="nav-link" href="{{ route('home') }}"><i
                                    class="fas fa-fire"></i><span>Dashboard</span></a>
                        </li>
                        <li class="menu-header">Links</li>
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i
                                    class="fas fa-columns"></i> <span>Contoh Halaman</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ route('statistic') }}">Contoh Statistik</a>
                                </li>
                                <li><a class="nav-link" href="{{ route('forms') }}">Contoh Form</a></li>
                                <li><a class="nav-link" href="{{ route('tables') }}">Contoh Tabel</a></li>
                            </ul>
                        </li>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2021 <div class="bullet"></div> Design By <a href="#">Tawalos</a>
                </div>
